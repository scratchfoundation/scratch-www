...
var getCountryOptions = function (intl, defaultCountry) {
    var options = countryOptions.concat({
...
export var UsernameStep = intl.injectIntl(React.createClass({
    getDefaultProps: function () {
        return {
            showPassword: false,
            waiting: false
...
export var ChoosePasswordStep = intl.injectIntl(React.createClass({
    getDefaultProps: function () {
        return {
            username: null,
            showPassword: false,
...
export var DemographicsStep = intl.injectIntl(React.createClass({
    getDefaultProps: function () {
        return {
            waiting: false,
            description: null,
...
export var NameStep = intl.injectIntl(React.createClass({
    getDefaultProps: function () {
        return {
            waiting: false
        };
...
export var PhoneNumberStep = intl.injectIntl(React.createClass({
    getDefaultProps: function () {
        return {
...
export var OrganizationStep = intl.injectIntl(React.createClass({
    getInitialState: function () {
        return {
            otherDisabled: true
        };
...
export var AddressStep = intl.injectIntl(React.createClass({
    getDefaultProps: function () {
        return {
            defaultCountry: DEFAULT_COUNTRY,
            waiting: false
...
export var UseScratchStep = intl.injectIntl(React.createClass({
    getDefaultProps: function () {
        return {
            waiting: false,
            maxCharacters: 300
...
export var EmailStep = intl.injectIntl(React.createClass({
    getDefaultProps: function () {
        return {
            waiting: false
        };
...
export var TeacherApprovalStep = intl.injectIntl(React.createClass({
    getDefaultProps: function () {
        return {
            email: null,
            invited: false,
...
export var ClassInviteNewStudentStep = intl.injectIntl(React.createClass({
    getDefaultProps: function () {
        return {
            waiting: false
        };
...
export var ClassInviteExistingStudentStep = intl.injectIntl(React.createClass({
    getDefaultProps: function () {
        return {
            classroom: null,
...
export var ClassWelcomeStep = intl.injectIntl(React.createClass({
    getDefaultProps: function () {
        return {
            waiting: false
        };
...
export var RegistrationError = intl.injectIntl(React.createClass({
    render: function () {
        return (
