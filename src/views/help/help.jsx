        ...
        return (
            ...
            <h1> Scratch Help </h1>
                <div className="leftcolumn">
                        ...
                        <div className="box-contents">
                            ...
                            <div className="guides">
                                <div className="scratch-guide">
                                    ...
                                    <h4><a href="https://cdn.scratch.mit.edu/scratchr2/static/__
                                    61560e08176805f6f84b8d1dd737d59b__/
                                    pdfs/help/Getting-Started-Guide-Scratch2.pdf">
                                    Getting Started Guide</a></h4>
                                ...
                                <div className="video-tutorials">
                                    ...
                                    <h4><a href="/help/videos">
                                    Video Tutorials</a></h4>
                    ...
                    <Box title="Explore the Scratch Community">
                        <div className="box-contents">
                            ...
                            <p> Click <img src="/images/help/follow-button-small.png"></img> on any profile to receive updates</p>
                        </div>
                    </Box>
                </div>
                <div className="rightcolumn">
                    ...
                    <Box title="Resources">
                        <div className="box-contents">
                            <h4><a href="http://scratched.gse.harvard.edu/">Scratch Ed</a></h4>
                            ...
                            <h4><a href="http://wiki.scratch.mit.edu/">Scratch Wiki</a></h4>
                            ...
                            <h4><a href="/scratch2download">Scratch 2.0 Offline Editor</a></h4>
                            <p> Download the Scratch 2 offline editor.</p>
                            <h4><a href="/scratch_1.4">Scratch 1.4 Download</a></h4>
                            <p> Links and information on the previous version of Scratch.</p>
                            <h4><a href="http://wiki.scratch.mit.edu/wiki/How_to_connect_to_the_physical_world">
                            Scratch and The Physical World</a></h4>
                            <p> Connect your Scratch projects to the physical world with
                            <a href="http://www.makeymakey.com/"> MaKey MaKey</a>,
                            <a href="https://education.lego.com/en-us/lesi/elementary/lego-education-wedo"> LEGO WeDo</a>, or
                            <a href="https://www.sparkfun.com/products/11888"> PicoBoard</a>.</p>
                            <h4><a href="http://wiki.scratch.mit.edu/wiki/Scratch_Media">Scratch Logo</a></h4>
