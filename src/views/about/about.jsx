        ...
        return (
            <div className="inner">
                ...
                <div className="intro">
                    ...
                    <p> <a href = "/parents/"> INFO FOR PARENTS </a> |<a href = "/educators/"> INFO FOR EDUCATORS </a></p>
				</div>
				<div className="video">
                ...
                <div className="information">
                    <div className="leftcolumn">
                     ...
                     <div className="rightcolumn">
                        ...
                        <p>Students are learning with Scratch at all levels (from elementary school to college) and across disciplines (such as math, computer science, language arts, social studies). Educators share stories, exchange resources, ask questions, and find people on the <a href="http://scratched.gse.harvard.edu/">ScratchEd website</a>.</p>
                        <h2>Research</h2>
                        <img src="/images/about/research-remix.png"></img>
                        <p>The MIT Scratch Team and collaborators are researching how people use and learn with Scratch (for an introduction, see <a href="http://web.media.mit.edu/~mres/papers/Scratch-CACM-final.pdf"><b>Scratch: Programming for All</b></a>). Find out more about Scratch <a href="/info/research">research</a> and <a href="/statistics">statistics</a> about Scratch.</p>
                        <h2>Support and Funding</h2>
                        <p>The Scratch project, initiated in 2003, has received generous support from the National Science Foundation (grants 0325828, 1002713, 1027848, 1019396), Intel Foundation, Microsoft, MacArthur Foundation, LEGO Foundation, Code-to-Learn Foundation, Google, Dell, Fastly, Inversoft, and MIT Media Lab research consortia. If you&#39;d like to support Scratch, please see our <a href="https://secure.donationpay.org/codetolearn/">donate page</a>, or contact us at donate@scratch.mit.edu.</p>
                    </div> 
                </div>
            </div>
        );
