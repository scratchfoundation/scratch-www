...
module.exports = [
    ...
    },
    {
        ...
        redirect: externalLinks.scratchFoundation.scratchConference
    },
    {
    ...
    },
    {
        ...
        pattern: '^/connect/?$',
        routeAlias: '/connect/?$',
        redirect: externalLinks.scratch.teacherTipsSignup
    },
    {
        name: 'contact-us',
        pattern: '^/contact-us/?(\\?.*)?$',
    ...
    },
    {
        name: 'jobs-redirect',
        pattern: '^/jobs/?(\\?.*)?$',
        redirect: externalLinks.scratchFoundation.careers
    },
    {
        name: 'join',
        pattern: '^/join/?$',
    ...
    {
        name: 'membership-redirect',
        pattern: '^/membership/?$',
        routeAlias: '/membership/?$',
        redirect: '/'
    },
    {
        name: 'messages',
    ...
    },
    {
        ...
        pattern: '^/info/donate/?',
        routeAlias: '/info/(cards|credits|faq|donate)/?$',
        redirect: externalLinks.scratchFoundation.donate
    },
    {
    ...
    {
        name: 'facesensing-tutorial-redirect',
        pattern: '^/face-sensing/?$',
        redirect: '/projects/editor/?tutorial=face-sensing'
    },
    {
